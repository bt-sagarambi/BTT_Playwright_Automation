...
/**
 * Locators for preconfigured Synthetic Performance Detail dashboard.
 * Route: site/dashboard | menu: Dashboards | option: Synthetic Performance Detail
 *
 ...
 */
export class SyntheticPerformanceDetailDashboardLocators {
